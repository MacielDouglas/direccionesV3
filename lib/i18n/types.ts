...
export type I18nDictionary = {
  ...
  addresses: {
    ...
    personChangedButton: string;
    personChangedBanner: string;
    personChangedQuestion: string;
    personChangedRevertQuestion: string;
    noVisitsButton: string;
    noVisitsBanner: string;
    noVisitsQuestion: string;
    noVisitsRevertQuestion: string;
    flagConfirm: string;
    flagRevert: string;
    flagSaved: string;
    inviteButton: string;
    inviteDialogHint: string;
    inviteTypeCelebration: string;
    inviteTypeConvention: string;
