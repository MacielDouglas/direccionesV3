...
export default async function Footer({ organization }: FooterProps) {
  ...
  return (
    <footer
      className="mt-auto w-full border-t border-border bg-card md:pb-0"
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="text-center lg:text-left">
            <Link
              ...
              className="inline-flex items-center gap-1.5 text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
            >
          ...
          <nav aria-label={t.footer.terms}>
            <ul className="flex flex-col items-center gap-4 text-sm sm:flex-row sm:gap-6 lg:justify-end">
              <li>
                <Link
                  href="/"
                  className="text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
                >
                  {t.common.appName}
                </Link>
              </li>
